...
class DroidDataset(InputDataset):
    """
    This is a tensor dataset that keeps track of all of the data streamed by droid.
    It's main purpose is to conform to the already defined workflow of nerfstudio:
        (dataparser -> inputdataset -> dataloader).

    In reality we could just store everything directly in droidDataloader, but this
    ...
    def __init__(
        ...
        self.exp_path = self.metadata["exp_path"]
